    ...
    return(
      ...
      <MDBRow>
              ...
              <MDBCol md="12" className="mt-3 mx-auto">
                <MDBJumbotron>
                  ...
                  <ul className="list-unstyled example-components-list">
                    <MenuLink to="#" title="Post Subject" />
                  </ul>
                </MDBJumbotron>
              </MDBCol>
            </MDBRow>
        ...
        <MDBCol md="7">
            <MDBRow >
                  <MDBCol md="12">
                  <MDBInput label="Subject Of Your Post" onChange={this.handleChange} value={this.state.value} />
                  </MDBCol>
            </MDBRow>
            <MDBRow >
                <MDBCol md="12">
                <MDBInput label="Describe Your Post" onChange={this.handleChange} value={this.state.value} />
                </MDBCol>
            </MDBRow>
